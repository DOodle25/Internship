...
// import axiosInstance from "../../utils/axios";
// import { useParams } from "react-router-dom";
// import { Snackbar, Alert, Chip, Avatar } from "@mui/material";
// import {
//   TextField,
//   Button,
//   Paper,
...
// const UpdateStudent = ({ token }) => {
//   const { id } = useParams();
//   const { users } = useGlobalContext(); // Fetch users from global context
//   const [user, setUser] = useState({
//     name: "",
//     age: "",
//     email: "",
...
//   const [snackbar, setSnackbar] = useState({ open: false, message: "", severity: "success" });
  ...
  // useEffect(() => {
  //   // Find the user in the global context
  ...
  //       isFormFilled: selectedUser.isFormFilled,
  //       isFormVerified: selectedUser.isFormVerified,
  //       isAdmin: selectedUser.isAdmin,
  //       tasksAssigned: selectedUser.tasksAssigned,
  //     });
  //   } else {
  //     // Fallback to API if user is not found in global context
  //     axiosInstance
  //       .get(`/admin/${id}`, {
  //         headers: { Authorization: `Bearer ${token}` },
  //       })
...
//               <Chip
//                 icon={<VerifiedIcon />}
//                 label={user.isFormVerified ? "Verified" : "Not Verified"}
//                 color={user.isFormVerified ? "success" : "error"}
//               />
//             </Grid>
//             <Grid item xs={4}>
//               <Chip
...
//                 label={user.isFormFilled ? "Form Filled" : "Form Not Filled"}
//                 color={user.isFormFilled ? "success" : "error"}
//               />
//             </Grid>
//           </Grid>
//         </Box>
