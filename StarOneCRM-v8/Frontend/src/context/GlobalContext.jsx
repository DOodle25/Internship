...
const GlobalContext = createContext();
// const socket = io("http://localhost:5000");
const socket = io("https://internship-fta5hkg7e8eaecf7.westindia-01.azurewebsites.net");
...
export const GlobalProvider = ({ children }) => {
  ...
  return (
    ...
    >
      ...
      <VideoCall otherUserId={videoCallUser} oncloseuser={oncloseuser} callRequest={callRequest} videoCallUser={videoCallUser} />
    </GlobalContext.Provider>
  );
};
